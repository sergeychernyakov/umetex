...
SECRET_KEY = 'django-insecure-m+9l+mfsp2ay1^fvl$rh2ugd=8n1dch(@44_z&1&r8yvcl3+j1'
...
ROOT_URLCONF = 'umetex_config.urls'
...
WSGI_APPLICATION = 'umetex_config.wsgi.application'
